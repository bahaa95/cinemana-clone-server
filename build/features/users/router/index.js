...
var UserRouter = /** @class */ (function (_super) {
    ...
    function UserRouter(usersController) {
        var _this = _super.call(this, '/users', usersController) || this;
    ...
    UserRouter.prototype.initializeRoutes = function () {
        ...
        this.router.post("".concat(this.path, "/signUp"), (0, limiter_1.limiter)({
            max: 6,
            windowMs: 1000 * 60 * 60,
        }), (0, validateResource_1.validateResource)(vlaidation_1.signupSchema), this.controller.signUp);
        // signin
        this.router.post("".concat(this.path, "/signIn"), (0, limiter_1.limiter)({
            max: 10,
            windowMs: 1000 * 60 * 60,
        }), (0, validateResource_1.validateResource)(vlaidation_1.signinSchema), this.controller.signIn);
        // log out
        this.router.post("".concat(this.path, "/logOut"), (0, limiter_1.limiter)({
            max: 10,
            windowMs: 1000 * 60 * 60,
        }), verifyJwt_1.verifyJwt, this.controller.logOut);
        // refresh token
