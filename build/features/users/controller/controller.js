...
var parseUser_1 = require("../utils/parseUser");
var cookieOptions = {
    httpOnly: true,
...
var UserController = /** @class */ (function () {
    function UserController(_userService) {
        ...
        this.signUp = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var data, passwordHash, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        data = (0, parseUser_1.parseUser)(req.body);
                        return [4 /*yield*/, bcrypt_1.bcrypt.hash(data.password)];
                    case 1:
                        passwordHash = _a.sent();
                        // save user to database
                        return [4 /*yield*/, this.userService.addUser(__assign(__assign({}, data), { password: passwordHash }))];
                    case 2:
                        // save user to database
                        _a.sent();
                        res.status(201).json({
        ...
        this.signIn = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, user, passwordMatch, accessTokenPayload, accessToken, refreshTokenPayload, refreshToken, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
                        _a = req.body, email = _a.email, password = _a.password;
                        return [4 /*yield*/, this.userService.getUser({ email: email })];
                    case 1:
                        user = _b.sent();
                        ...
                        return [4 /*yield*/, bcrypt_1.bcrypt.compare(password, user.password)];
                    case 2:
        ...
        this.refreshToken = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var cookies, payload, _a, _id, user, accessTokenPayload, accessToken, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 7, , 8]);
                    ...
                    case 3:
                        _a = _b.sent();
                        res.clearCookie('refreshToken');
                        throw new httperror_1.HttpError({ status: httperror_1.statuses.Forbidden });
                    case 4:
                        _id = (0, convertToObjectId_1.convertToObjectId)(payload.User._id);
                        return [4 /*yield*/, this.userService.getUser({ _id: _id })];
                    case 5:
                        user = _b.sent();
                        // throw HttpError if user not found
                        if (!user) {
                    ...
                    case 6:
                        accessToken = _b.sent();
                        res.status(202).json({ accessToken: accessToken, userName: user.username });
                        return [3 /*break*/, 8];
                    case 7:
                        error_3 = _b.sent();
                        next(error_3);
