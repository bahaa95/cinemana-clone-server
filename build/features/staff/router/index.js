...
var StaffRouter = /** @class */ (function (_super) {
    ...
    function StaffRouter(_staffController) {
        var _this = _super.call(this) || this;
        _this.path = '/staff/person';
        _this.router = (0, express_1.Router)();
        _this.staffController = _staffController;
        _this.initializeRoutes();
        return _this;
    }
    StaffRouter.prototype.getRoutes = function () {
        return this.router;
    };
