    ...
    function Bcrypt() {
        ...
        this.hash = function (plainText) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bcrypt.hash(plainText, this.salt)];
         ...
         */
        this.compare = function (plainText, hash) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bcrypt.compare(plainText, hash)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
